$(document).ready(function() {
    ...
    function start(word) {
        ...
        function wrong(letter) {
            ...
            // if this wrong letter hasn't been guessed before, add it to the list and incrase the count
            if (wrongGuesses.indexOf(letter) == -1) {
                ...
                // idk maybe do something if they've already guessed this letter?
            }
